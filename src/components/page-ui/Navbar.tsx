    ...
    >
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Social">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink
              href="https://github.com/rolderisa"
            ...
            <HoveredLink
              href="https://www.linkedin.com/in/irisa-shimirwa-rolande-22a141261/"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="irisa-bz79r0eal-irisas-projects-175f74bb.vercel.app"
              rel="noopener noreferrer"
              target="_blank"
            >
